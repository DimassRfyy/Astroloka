        ...
        <div class="flex flex-col mt-20 gap-[50px]">
            ...
            <div class="flex flex-col gap-5">
                <div class="flex items-center gap-[10px]">
                    ...
                    <p class="font-semibold text-cp-dark-blue">No 96, Astroloka Jakarta</p>
                </div>
                <div class="flex items-center gap-[10px]">
                    <div class="flex w-6 h-6 shrink-0">
                ...
                <div class="flex items-center gap-[10px]">
                    ...
                    <p class="font-semibold text-cp-dark-blue">astroloka.com</p>
                </div>
            </div>
        </div>
            ...
            <div class="flex flex-col gap-10">
                <div class="flex items-center gap-3">
                    ...
                    <div class="flex flex-col">
                        <p id="CompanyName" class="font-extrabold text-xl leading-[30px] text-white">Astroloka</p>
